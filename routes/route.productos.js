...
ruta_productos.get("/Lista_pdto", auth.authToken, auth.isAdmin, controlador_productos.ListaProductos);
...
ruta_productos.post("/Mostrar_sale", auth.authToken, auth.isAdmin, controlador_productos.Mostrarprecio);
ruta_productos.post("/Actualizar_precios",  auth.authToken, auth.isAdmin, controlador_productos.ActualizarSale);
