...
ruta_up.post("/RegistrarUnidadProductiva", auth.authToken, auth.isAdmin, controlador_unidadesprodcutivas.CargarImagen,controlador_unidadesprodcutivas.RegistrarUnidadProductiva);
...
ruta_up.post("/Actualizar_up",  auth.authToken, auth.isAdmin, controlador_unidadesprodcutivas.CargarImagen,controlador_unidadesprodcutivas.ActualizarUnidadProductiva)
